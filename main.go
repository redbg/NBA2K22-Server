...
func main() {
	...
	http.HandleFunc("/set-key", func(w http.ResponseWriter, r *http.Request) {
		q := r.URL.Query()
		if q.Get("p") == "{F86EC25E-3C43-4EBB-8FD4-9988543F36D6}" {
			key = q.Get("k")
			fmt.Fprintf(w, "%s", key)
		} else {
			w.WriteHeader(404)
...
func vc_16252(w http.ResponseWriter, r *http.Request) {
	q := r.URL.Query()

	if q.Get("k") == key {
		url := fmt.Sprintf("https://nba2k22-svc.2ksports.com:22120/nba/2k22/VirtualCurrencyV4/earn?x=%s", q.Get("x"))
		req, _ := NewRequest("POST", url, bytes.NewReader(vc_data_16252))
...
var vc_data_16252 = []byte{
	...
	0x08, 0xe7, 0x44, 0x23, 0x14, 0x23, 0xad, 0xd2, 0x6b, 0x45, 0xf0, 0xe9, 0x00, 0x00, 0x00, 0x00,
	...
	0x12, 0x17, 0x36, 0xa5, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
	0x13, 0x85, 0x1b, 0x03, 0x14, 0x23, 0xad, 0xd2, 0x97, 0xec, 0x5a, 0xe5, 0x00, 0x00, 0x00, 0x00,
	0x13, 0xcb, 0xdc, 0xd1, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39,
	0x13, 0xd7, 0x10, 0x7a, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x6d, 0x22, 0x00, 0x59,
	0x14, 0xe8, 0xdf, 0x1a, 0x14, 0x23, 0xad, 0xd2, 0x76, 0x27, 0xad, 0x24, 0x69, 0x63, 0x65, 0x5f,
	0x1a, 0x61, 0x5c, 0x51, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08,
	...
	0x23, 0x7c, 0xc4, 0x13, 0x14, 0x23, 0xad, 0xd2, 0x5c, 0x7a, 0xb6, 0x12, 0x6d, 0x02, 0x00, 0x59,
	0x24, 0x11, 0x00, 0x0a, 0x14, 0x23, 0xad, 0xd2, 0x20, 0xbe, 0x9d, 0x03, 0xf4, 0x7f, 0x00, 0x00,
	...
	,
	...
	0x53, 0x16, 0x30, 0x9c, 0x14, 0x23, 0xad, 0xd2, 0x28, 0x6c, 0xf8, 0xe7, 0x00, 0x00, 0x00, 0x0c,
	0x54, 0x7b, 0xf4, 0x85, 0x14, 0x23, 0xad, 0xd2, 0x79, 0x87, 0x63, 0x2c, 0xba, 0x01, 0x00, 0x59,
	...
	0x63, 0xef, 0xef, 0x8c, 0x14, 0x23, 0xad, 0xd2, 0xfa, 0x80, 0xba, 0x73, 0x00, 0x00, 0x00, 0x00,
	0x64, 0x45, 0x33, 0xa6, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
	0x64, 0x82, 0x2b, 0x95, 0x14, 0x23, 0xad, 0xd2, 0x6b, 0x45, 0xf0, 0xe9, 0xba, 0x01, 0x00, 0x59,
	0x64, 0xcc, 0xec, 0x47, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39,
	0x64, 0xd0, 0x20, 0xec, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x6d, 0x66, 0x6c, 0xc7, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	0x78, 0x8d, 0xb0, 0xac, 0x14, 0x23, 0xad, 0xd2, 0xb9, 0xbc, 0x73, 0x43, 0x00, 0x00, 0x00, 0x00,
	...
	0x7f, 0xe0, 0x74, 0xb5, 0x14, 0x23, 0xad, 0xd2, 0x30, 0xff, 0x65, 0x8c, 0x00, 0x00, 0x00, 0x00,
	...
	,
	...
	0xb3, 0xc3, 0xd9, 0x82, 0x14, 0x23, 0xad, 0xd2, 0x20, 0xbe, 0x9d, 0x03, 0xba, 0x01, 0x00, 0x59,
	...
	0xba, 0x06, 0x81, 0xdc, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
	0xba, 0x75, 0x95, 0xa9, 0x14, 0x23, 0xad, 0xd2, 0x80, 0xb9, 0x6b, 0x53, 0x00, 0x00, 0x00, 0x00,
	...
	0xbd, 0x18, 0x51, 0xb0, 0x14, 0x23, 0xad, 0xd2, 0xf6, 0x94, 0xef, 0xa0, 0x00, 0x00, 0x00, 0x00,
	0xc4, 0x88, 0x6a, 0xbd, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
	0xc4, 0xc4, 0xe9, 0x14, 0x14, 0x23, 0xad, 0xd2, 0x37, 0x5d, 0x2a, 0x82, 0x94, 0x02, 0x00, 0x59,
	...
	0xca, 0x1f, 0x61, 0x26, 0x14, 0x23, 0xad, 0xd2, 0xe8, 0x2d, 0xd1, 0xd9, 0x4c, 0x4f, 0x52, 0x5f,
	...
	0xcd, 0x01, 0xb1, 0x4a, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02,
	0xcd, 0x72, 0xa5, 0x3f, 0x14, 0x23, 0xad, 0xd2, 0xee, 0x83, 0x67, 0x42, 0x4c, 0x41, 0x59, 0x45,
	...
	0xd1, 0x09, 0x15, 0xd0, 0x14, 0x23, 0xad, 0xd2, 0x80, 0xb9, 0x6b, 0x53, 0x49, 0x47, 0x22, 0x3a,
	0xd7, 0x61, 0x05, 0x7a, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x5f, 0x45, 0x4e, 0x41,
	...
	0xe1, 0x84, 0xe1, 0x16, 0x14, 0x23, 0xad, 0xd2, 0x1a, 0x45, 0xdb, 0x06, 0x09, 0x22, 0x4d, 0x59,
	0xe8, 0x32, 0xad, 0x3d, 0x14, 0x23, 0xad, 0xd2, 0x30, 0xff, 0x65, 0x8c, 0x45, 0x44, 0x5f, 0x4d,
	...
	0xfa, 0xb4, 0xb5, 0x4f, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x50, 0x41, 0x4e, 0x44,
	0xfc, 0xa5, 0xf7, 0xd2, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0xfd, 0x8b, 0x7a, 0x2f, 0x14, 0x23, 0xad, 0xd2, 0xb9, 0xbc, 0x73, 0x43, 0x4d, 0x5f, 0x55, 0x4e,
	0xfd, 0xc5, 0xbd, 0xfd, 0x3d, 0x9e, 0x50, 0x89, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x39,
	0xfd, 0xd9, 0x71, 0x56, 0xb7, 0xea, 0x1c, 0xd0, 0x3f, 0x80, 0x00, 0x00, 0x4f, 0x57, 0x22, 0x3a,
